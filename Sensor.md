...
9.  The device sensors shall receive data to calculate the speed
    \[Conceptual Design\]
...
This system must be able to obtain several accurate samples within the
...
![](media/image3.png){width="6.5in" height="3.0770833333333334in"}
