...
| 3. | The interceptor must have lights that are bright enough to be seen by the judges approximately fifteen feet away, which is over twice the length of the gameboard. These lights must be powered by a 5V source from the processor block and must emit a light that falls within the visual light spectrum of 380 to 720 nanometers [1]. | Rulebook / System |
...
Using the candela to lumen calculator [11], the value of 25cd that these lights are rated for and the viewing angle which is 30 degrees for the green LED [8] and 18 degrees for the red LED [7] is used. The values are taken in and the lumen value for the green LED is 5.352 lumens and for the red LED it is 1.934 lumens. This value can then be converted to foot candles using the following equation [12]. It can now be said that the green LED's will have a value of 5.352 fcd and the red LED's will have a value of 1.934 fcd. Because of the theorem of superposition and the total of ten LED's the new values will be 53.52 total fcd for the green LED's and 19.34 total fcd for the red LED's. This means that the LED's will illuminate a total of 53.52ft² and 19.34ft².
